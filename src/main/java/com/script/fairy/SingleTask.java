    ...
    public void heroTrial()throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                result =mFairy.findPic(82,1168,318,1270,new String[]{"Sweep away3.png","jxsd.png"});
               ...
               // LtLog.e("---------------------------------------"+result.sim);
                ...
                result = mFairy.findPic(260,806,443,1084,"Sweep away close.png");
                ...
                result = mFairy.findPic(358,453,576,829,"fail.png");
                if (result.sim > 0.8f){
                    result = mFairy.findPic("cancel2.png");
    ...
    public void oneThousand() throws Exception{
        new SingleTask(mFairy){
            ...
            public void content_2() throws Exception {
                ...
                result = mFairy.findPic(558,253,646,348,"my.png");
                if(result.sim > 0.8f){
                    LtLog.e("拼凑中");
    ...
    public void riversLakes()throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                if (dazeTime > 10){
                    result = mFairy.findPic(5,484,261,556,"quxiao Flow.png");
                    mFairy.onTap(0.8f, result, "取消跟随", 1000);
                    result = mFairy.findPic(625,906,715,1170,new String[]{"motor2.png","motor3.png"});
