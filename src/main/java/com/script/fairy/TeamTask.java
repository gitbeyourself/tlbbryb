    ...
    public void  oldThreeRings()throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                result1 = mFairy.findPic("Sign out2.png");
                if (result.sim >= 0.8f || result1.sim >= 0.8f){
                    result = mFairy.findPic(625,906,715,1170,"motor2.png");
    ...
    public void   rebel()throws Exception{
        new SingleTask(mFairy){
            ...
            public void content_3() throws Exception {
                ...
                result = mFairy.findPic(61,488,645,627,"fzrq.png");
                mFairy.onTap(0.8f,result,470,723,482,733,"设置目标匹配",Sleep);

                result = mFairy.findPic(126,433,566,821, "zbll.png");
                mFairy.onTap(0.65f, result,"点击反贼", Sleep);

                result = mFairy.findPic(23,824,699,1010,"eliminate.png");
